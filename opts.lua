...
function M.parse(arg)
   ...
   cmd:option('-dataset',    'imagenet_list', 'Options: imagenet | cifar10')
   ...
   cmd:option('-nStocSamples',    10,      'Number of stochastic test samples')
   cmd:option('-tenCrop',         'false', 'Ten-crop testing')
   cmd:option('-testScales',      {256,384,512}, 'Multiple scales')
   cmd:option('-saveInterval',    99,      'Save result interval')
